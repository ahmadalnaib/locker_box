<x-app-layout>
  ...
  <div class="container my-12 mx-auto md:px-12 p-5">
      <h1 class="text-2xl p-5 mb-2">Add Locker  </h1>
      <hr class="mb-5"/>
      <form class="form-contact" action="{{ route('place.store') }}" method="post"  enctype="multipart/form-data">
          ...
          <div class="grid grid-cols-2 gap-4">
              ...
              <div class="">
                  <label for="catg"> Choose City </label>
          ...
          <div class="">
                  <label for="overview">  About the Place </label>
          ...
          <div class="">
                  <label for="details"> Upload photo  </label>
                  <input type="file" name="image"  class="form-control">
          </div>
        
          <div class="mt-4">
                  <label for="address1"> <Address></Address></label>
          ...
          <div class="form-group col-lg-6">
                  <label for="long">Langitude </label>
          ...
          <button type="submit" class="mt-3 bg-blue-600 text-gray-200 rounded hover:bg-blue-500 px-4 py-2 focus:outline-none">Add</button>
